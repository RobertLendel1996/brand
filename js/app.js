(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".portfolio-content__slider")) new core(".portfolio-content__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".portfolio-content__slider .swiper-button-prev",
                nextEl: ".portfolio-content__slider .swiper-button-next"
            }
        });
        if (document.querySelector(".portfolio-design__slider")) new core(".portfolio-design__slider", {
            ...
            navigation: {
                prevEl: ".portfolio-design__slider .swiper-button-prev",
                nextEl: ".portfolio-design__slider .swiper-button-next"
            }
        });
        ...
        if (document.querySelector(".commendation__slider")) new core(".commendation__slider", {
